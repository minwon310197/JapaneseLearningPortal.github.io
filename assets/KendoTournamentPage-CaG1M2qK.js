const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./KendoDojoScene-DGd0UxJj.js","./vendor-react-BUL8WuXG.js"])))=>i.map(i=>d[i]);
...
import { h as useLearningStore, H as getQualityConfig } from "./index-BEJSIlFS.js";
...
import { S as ScreenShakeProvider, u as useScreenShake } from "./HitPause-BapLYhfu.js";
...
const KendoDojo = React.lazy(() => __vitePreload(() => import("./KendoDojoScene-DGd0UxJj.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((module) => ({ default: module.KendoDojo })));
const TARGETS = [
