import { ab as S, bB as shuffleArray, bK as esc, s as safeGetItem } from "./feature-3d-CFvJkEt3.js";
...
function openAnalyticsDash() {
  ...
  var items = [
    { label: "Từ vựng", cur: reviewed, max: allV, color: "var(--accent)" },
...
function openVocabGrowth() {
  ...
  var known = Object.keys(srs).length;
