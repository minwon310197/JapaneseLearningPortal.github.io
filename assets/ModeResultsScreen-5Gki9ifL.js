...
import { h as useLearningStore, aM as srs, F as content, L as speakJP, k as kanaToRomaji } from "./index-BEJSIlFS.js";
...
function useBookmarkQueue() {
  ...
  const list2 = reactExports.useCallback(() => Object.keys(bookmarks || {}), [bookmarks]);
  ...
  return reactExports.useMemo(
    () => ({ add, remove, toggle, has, list: list2, count, dueCount, listDue }),
    [add, remove, toggle, has, list2, count, dueCount, listDue]
  );
}
const JAP_RE = /[\u3040-\u30FF\u3400-\u9FFF]/;
