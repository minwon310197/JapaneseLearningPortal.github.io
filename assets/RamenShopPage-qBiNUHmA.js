const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./RamenCounterScene-Dn9Zem7p.js","./vendor-react-BUL8WuXG.js"])))=>i.map(i=>d[i]);
...
import { h as useLearningStore, bL as useTakaraStore, bM as getCookingBuffDescription } from "./index-BEJSIlFS.js";
import { S as SubgameCanvas } from "./SubgameCanvas-CaGN2HcP.js";
import { R as RarityAura } from "./RarityAura-BqxZE2kk.js";
import { c as RARITY_LABELS_VI } from "./rarity-tokens-i3-fv4xK.js";
...
const RamenCounter = React.lazy(() => __vitePreload(() => import("./RamenCounterScene-Dn9Zem7p.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((module) => ({ default: module.RamenCounter })));
