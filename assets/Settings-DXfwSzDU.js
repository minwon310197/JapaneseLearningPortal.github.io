...
import { e as safeGetItem, f as STORAGE_KEYS, au as safeGetObjectItem, N as safeSetItem, z as safeSetObjectItem, r as resetAppStoreToDefaults, u as useAppStore, D as useManagedTimeout, U as useAIKey, av as THEME_FAMILIES, aw as getThemeVariant, ax as getJapaneseVoices, ay as getVietnameseVoices, az as getPreferredVoiceName, aA as setPreferredVoice, as as speakJP, aB as speakVi, d as useLearningStore, aC as resolveThemeMode, aD as SettingsHeroScene } from "./feature-3d-ClP3ARU5.js";
import { x as startAutoBackup, y as signInWithGoogle, z as logoutAndClearAccount, s as syncNow, A as stopAutoBackup, c as getUserErrorMessage, B as resetAllAndSync } from "./index-ZUSnnghe.js";
...
function ThemePresetPicker({ activeThemeMode, themePreset, applyThemePreset, learning }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-theme-group-label", children: [
      ...
      " • cùng một họ giao diện sẽ tự chuyển giữa Day/Night"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "n4-theme-preset-grid", children: THEME_FAMILIES.map((preset) => {
      var _a, _b, _c;
      const isPremium = !FREE_THEMES.includes(preset.id);
      const isOwned = !isPremium || !!((_a = learning.unlockedItems) == null ? void 0 : _a[`theme-${preset.id}`]);
      const preview = getThemeVariant(preset.id, activeThemeMode);
      const darkAccent = (_b = getThemeVariant(preset.id, "dark")) == null ? void 0 : _b.accent;
      const lightAccent = (_c = getThemeVariant(preset.id, "light")) == null ? void 0 : _c.accent;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          className: `n4-theme-preset-card ${themePreset === preset.id ? "active" : ""} ${!isOwned ? "locked" : ""}`,
          onClick: () => isOwned ? applyThemePreset(preset) : null,
          title: !isOwned ? "Mua trong Shop để mở khóa theme này" : preset.name,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-theme-preset-preview", style: !isOwned ? { opacity: 0.45, filter: "grayscale(0.6)" } : void 0, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-theme-preset-info", children: [
              ...
              !isOwned ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/shop", className: "n4-theme-shop-link", onClick: (event) => event.stopPropagation(), style: { fontSize: "0.65rem", color: "var(--n4-accent)", textDecoration: "underline", marginTop: 2, display: "inline-block" }, children: "Mua trong cửa hàng" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, marginTop: 4, fontSize: "0.68rem", color: "var(--n4-text-secondary)" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 4 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { width: 8, height: 8, borderRadius: 999, background: darkAccent } }),
                  "Tối"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 4 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { width: 8, height: 8, borderRadius: 999, background: lightAccent } }),
                  "Sáng"
                ] })
              ] })
            ] })
...
const LEARNING_MODES = [
  {
    ...
    icon: "◎",
    label: "Nhẹ nhàng",
    description: "Ít áp lực, có đọc mẫu và nhịp học chậm hơn.",
    values: { difficulty: "easy", dailyGoal: 30, newItemsPerDay: 6, autoAdvance: false, ttsRate: 0.8, autoSpeak: true, density: "comfortable", showFurigana: true, showRomaji: true }
  },
  {
    id: "balanced",
    icon: "◐",
    label: "Cân bằng",
    description: "Nhịp học N4 hằng ngày được khuyến nghị.",
    values: { difficulty: "normal", dailyGoal: 50, newItemsPerDay: 10, autoAdvance: false, ttsRate: 0.9, autoSpeak: false, density: "comfortable", showFurigana: true, showRomaji: true }
  },
  {
    id: "intensive",
    icon: "↗",
    label: "Tăng tốc",
    description: "Nhiều câu hơn, ít trợ giúp hơn, phù hợp ôn thi.",
    values: { difficulty: "jlpt", dailyGoal: 100, newItemsPerDay: 15, autoAdvance: true, ttsRate: 1, autoSpeak: false, density: "compact", showFurigana: true, showRomaji: false }
  }
];
const DIFFICULTY_LABELS = { easy: "Dễ", normal: "Bình thường", hard: "Khó", jlpt: "JLPT" };
function Toggle({ checked, label, onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: `n4-settings-controller-toggle ${checked ? "is-on" : ""}`, "aria-pressed": checked, onClick, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "n4-settings-controller-switch", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", {}) })
  ] });
}
function SmartSettingsController({ settings: s, activeThemeMode, onOpenSettings }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "n4-settings-controller", "aria-labelledby": "settings-controller-title", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings-controller-heading", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "n4-settings-controller-kicker", children: "TRUNG TÂM ĐIỀU KHIỂN" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { id: "settings-controller-title", children: "Cài đặt theo cách bạn học" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Một nơi để chỉnh nhịp học, cách hiển thị và trợ giúp — thay vì phải đổi từng mục nhỏ." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings-controller-status", "aria-label": `Độ khó hiện tại: ${DIFFICULTY_LABELS[s.difficulty] || "Bình thường"}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Hôm nay" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
          s.dailyGoal,
          " XP"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: DIFFICULTY_LABELS[s.difficulty] || "Bình thường" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "n4-settings-mode-grid", role: "group", "aria-label": "Chọn nhịp học", children: LEARNING_MODES.map((mode) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        className: `n4-settings-mode ${appliedMode === mode.id ? "is-selected" : ""}`,
        onClick: () => applyMode(mode),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "n4-settings-mode-icon", "aria-hidden": "true", children: mode.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "n4-settings-mode-copy", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: mode.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: mode.description })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "n4-settings-mode-action", children: "Áp dụng" })
        ]
      },
      mode.id
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings-controller-quick", "aria-label": "Điều khiển nhanh", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings-controller-section-label", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Điều khiển nhanh" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: "Áp dụng ngay" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings-controller-grid", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings-controller-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Chế độ sáng/tối" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings-controller-segmented", role: "group", "aria-label": "Chế độ màu", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: activeThemeMode === "light" ? "is-active" : "", onClick: () => s.setThemeMode("light"), children: "☀️ Sáng" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: activeThemeMode === "dark" ? "is-active" : "", onClick: () => s.setThemeMode("dark"), children: "🌙 Tối" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings-controller-field", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Độ khó" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "n4-settings-controller-segmented", role: "group", "aria-label": "Độ khó", children: Object.entries(DIFFICULTY_LABELS).map(([value, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: s.difficulty === value ? "is-active" : "", onClick: () => s.setDifficulty(value), children: label }, value)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "n4-settings-controller-field n4-settings-controller-range", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "Mục tiêu hôm nay ",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
              s.dailyGoal,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "range", "aria-label": "Mục tiêu XP hôm nay", min: "10", max: "200", step: "10", value: s.dailyGoal, onChange: (event) => s.setDailyGoal(Number(event.target.value)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "n4-settings-controller-field n4-settings-controller-range", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "Tốc độ phát âm ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "range", "aria-label": "Tốc độ phát âm", min: "0.3", max: "2", step: "0.1", value: s.ttsRate, onChange: (event) => s.setTtsRate(Number(event.target.value)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings-controller-toggles", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Hiện Furigana", checked: s.showFurigana, onClick: s.toggleFurigana }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Hiện Romaji", checked: s.showRomaji, onClick: s.toggleRomaji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { label: "Tự động phát âm", checked: s.autoSpeak, onClick: () => s.setAutoSpeak(!s.autoSpeak) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "n4-settings-controller-more", onClick: () => onOpenSettings("display"), children: [
      "Mở các điều khiển chi tiết ",
...
function Settings() {
  ...
  const [activeTab, setActiveTab] = reactExports.useState("controller");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings n4-page-enter", children: [
    ...
    !isSearching && activeTab === "controller" && /* @__PURE__ */ jsxRuntimeExports.jsx(SmartSettingsController, { settings: s, activeThemeMode, onOpenSettings: setActiveTab }),
    !isSearching && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "n4-settings-tabs", style: { padding: "0 var(--n4-sp-4)", marginBottom: "var(--n4-sp-3)" }, children: [{ id: "controller", icon: "⌘", label: "Điều khiển" }, ...TABS].map((tab) => {
      const isActive = activeTab === tab.id;
      const count = tab.id !== "controller" ? tabCounts[tab.id] : null;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
    ...
    }) : activeTab !== "controller" && ((_a = TAB_SECTIONS[activeTab]) == null ? void 0 : _a.map((sectionId) => {
      const sectionItems = displayedItems.filter((item) => item.section === sectionId);
      if (sectionItems.length === 0) return null;
      const sec = SECTIONS[sectionId] || {};
      return /* @__PURE__ */ jsxRuntimeExports.jsx(IOSGroupedList, { header: sec.header, footer: sec.footer, children: sectionItems.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-settings-row-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(IOSGroupedRow, { label: item.label, description: item.desc, right: item.ctrl, compact: item.compact }),
        item.preview && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "n4-settings-preview", style: { padding: "0 var(--n4-sp-4) var(--n4-sp-2)" }, children: item.preview })
      ] }, `${sectionId}-${i}`)) }, sectionId);
    })),
    displayedItems.length === 0 && (isSearching || activeTab !== "controller") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-empty-state n4-settings-empty", children: [
