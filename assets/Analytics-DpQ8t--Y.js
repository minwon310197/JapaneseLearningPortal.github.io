...
import { h as useLearningStore, a as useDataStore, _ as getSrsLevel, $ as getGrammarLabel, a0 as getVocabLabel, a1 as makeLearningKey } from "./index-BEJSIlFS.js";
import { g as getTrainerMeta } from "./registry-BAotxlgH.js";
...
function BarChart({ data, labelKey, valueKey, height = 120, color = "var(--n4-accent)" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      width: "100%",
      viewBox: `0 0 ${totalW} ${height + 28}`,
      style: { display: "block" },
      role: "img",
      "aria-label": "Biểu đồ cột thể hiện số câu đã trả lời trong các ngày gần đây",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Biểu đồ cột hoạt động hằng ngày" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("desc", { children: "Trục hoành biểu diễn thời gian, trục tung biểu diễn số câu đã trả lời trong ngày." }),
        data.map((d, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
            ...
            d[valueKey] > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: x + barW / 2, y: height - h - 3, textAnchor: "middle", fontSize: "9", fill: "var(--n4-text-muted)", children: d[valueKey] }),
...
function AccuracyChart({ data, height = 110 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      style: { display: "block" },
      role: "img",
      "aria-label": "Biểu đồ đường biểu diễn tỷ lệ trả lời chính xác theo ngày",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Biểu đồ đường tỷ lệ chính xác" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("desc", { children: "Trục hoành biểu diễn các ngày có hoạt động, trục tung biểu diễn tỷ lệ chính xác từ 0 đến 100%." }),
        ...
        [0, 25, 50, 75, 100].map((pct) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { x: padX - 4, y: y + 3, textAnchor: "end", fontSize: "9", fill: "var(--n4-text-muted)", children: [
              pct,
              "%"
            ] })
          ] }, pct);
        ...
        coords.map((c, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: c.x, y: height + 14, textAnchor: "middle", fontSize: "9", fill: "var(--n4-text-secondary)", children: fmtDate(c.date) }, `l${i}`);
        })
      ]
    }
  );
}
function ChartDataTable({ data, kind }) {
  const rows = kind === "accuracy" ? data.filter((entry) => entry.total > 0) : data;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "n4-chart-table", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { children: "Xem dữ liệu dạng bảng" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "n4-table-scroll", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "n4-analytics-table", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("caption", { className: "n4-sr-only", children: kind === "accuracy" ? "Độ chính xác theo ngày" : "Số câu đã học theo ngày" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Ngày" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Tổng câu" }),
        kind === "accuracy" && /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", children: "Chính xác" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: fmtDate(entry.date) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: entry.total }),
        kind === "accuracy" && /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { children: [
...
function TrainerTable({ trainerStats, gameHistory }) {
  const entries = reactExports.useMemo(() => {
    ...
    return Object.entries(trainerStats || {}).map(([id, s]) => {
      ...
      return {
        id,
        label: ((_a = getTrainerMeta(id)) == null ? void 0 : _a.title) || id.replace(/-/g, " ").replace(/\b\w/g, (c) => c.toUpperCase()),
        plays: s.plays,
        correct: s.correct,
        total: s.total,
        accuracy,
...
function SRSHealth({ srs }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "n4-analytics-explainer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { children: "“Thuộc” nghĩa là gì?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Một mục được tính là thuộc khi đã tiến tới hộp SRS 4 hoặc 5. Bạn vẫn sẽ gặp lại mục đó theo lịch ôn giãn cách để duy trì trí nhớ." })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { overflowX: "auto" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "n4-analytics-table n4-responsive-table", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: pageItems.map((s, i) => {
        ...
        const label = ((_a = getTrainerMeta(s.trainerId)) == null ? void 0 : _a.title) || ((_b = s.trainerId) == null ? void 0 : _b.replace(/-/g, " ")) || "—";
...
function Analytics() {
  ...
  const { vocab, kanji, grammar } = useDataStore(useShallow((s) => ({ vocab: s.vocab, kanji: s.kanji, grammar: s.grammar })));
  const days90 = reactExports.useMemo(() => lastNDays(90), []);
  const allDailyData = reactExports.useMemo(() => {
    return days90.map((date) => {
      const entry = resolveEntry(studyHistory[date]);
      return { date, ...entry };
    });
  }, [days90, studyHistory]);
  const dailyData = reactExports.useMemo(() => allDailyData.slice(-rangeDays), [allDailyData, rangeDays]);
  ...
  const readinessRows = [
    { label: "Độ chính xác", value: avgAccuracy, detail: `${totalStudied} câu trong ${rangeDays} ngày`, to: "/practice" },
    { label: "Độ bao phủ", value: coveragePct, detail: `${itemsStudied}/${totalItems} mục đã chạm`, to: "/learn" },
    { label: "Tính nhất quán", value: Math.round(activeDays / rangeDays * 100), detail: `${activeDays}/${rangeDays} ngày có hoạt động`, to: "/" }
  ];
  const weakTrainers = reactExports.useMemo(() => Object.entries(trainerStats || {}).map(([id, value]) => {
    var _a;
    const total = Number((value == null ? void 0 : value.total) || 0);
    const correct = Number((value == null ? void 0 : value.correct) || 0);
    return { id, total, accuracy: total ? Math.round(correct / total * 100) : 0, label: ((_a = getTrainerMeta(id)) == null ? void 0 : _a.title) || id.replaceAll("-", " ") };
  }).filter((item) => item.total >= 3 && item.accuracy < 70).sort((a, b) => a.accuracy - b.accuracy).slice(0, 3), [trainerStats]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-page", style: { padding: "var(--n4-sp-4)" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "n4-analytics-range", role: "group", "aria-label": "Khoảng thời gian phân tích", children: [7, 30, 90].map((days) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: `n4-btn n4-btn-sm ${rangeDays === days ? "n4-btn-primary" : "n4-btn-ghost"}`, "aria-pressed": rangeDays === days, onClick: () => setRangeDays(days), children: [
      days,
      " ngày"
    ] }, days)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "n4-sr-only", "aria-live": "polite", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-analytics-summary", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-analytics-stat", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-analytics-stat-label", children: [
          "Chính xác ",
          rangeDays,
          " ngày"
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-analytics-learning-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "n4-card n4-analytics-readiness", "aria-labelledby": "readiness-title", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { id: "readiness-title", children: "Mức sẵn sàng N4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "n4-muted", children: "Chỉ báo định hướng dựa trên dữ liệu học trong ứng dụng, không phải dự đoán kết quả thi." }),
        readinessRows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "n4-readiness-row", onClick: () => navigate(row.to), "aria-label": `${row.label}: ${row.value}%. Mở nội dung liên quan`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: row.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: row.detail })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "n4-readiness-meter", role: "progressbar", "aria-label": row.label, "aria-valuemin": "0", "aria-valuemax": "100", "aria-valuenow": row.value, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { width: `${Math.min(100, row.value)}%` } }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "n4-card n4-analytics-mistakes", "aria-labelledby": "mistakes-title", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { id: "mistakes-title", children: "Mẫu lỗi cần ưu tiên" }),
        weakTrainers.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: weakTrainers.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
            item.accuracy,
            "%"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "n4-btn n4-btn-sm n4-btn-ghost", onClick: () => navigate(`/trainer/${item.id}`), children: "Luyện ngay" })
        ] }, item.id)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Chưa đủ dữ liệu để xác định mẫu lỗi. Hoàn thành thêm một bài luyện để nhận gợi ý." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "n4-btn n4-btn-ghost", onClick: () => navigate("/practice"), children: "Mở Luyện tập" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-card", style: { padding: "var(--n4-sp-4)", marginBottom: "var(--n4-sp-4)" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-card", style: { padding: "var(--n4-sp-4)", marginBottom: "var(--n4-sp-4)" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(WeeklyComparison, { dailyData: allDailyData })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-card", style: { padding: "var(--n4-sp-4)", marginBottom: "var(--n4-sp-4)" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { style: { margin: "0 0 var(--n4-sp-3)", fontSize: "var(--n4-fs-md)" }, children: [
        "📈 Hoạt động ",
        rangeDays,
        " ngày"
      ] }),
      totalStudied > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChartDataTable, { data: dailyData, kind: "activity" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center", padding: "var(--n4-sp-3)", color: "var(--n4-text-secondary)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "var(--n4-fs-sm)", margin: 0 }, children: [
        "Chưa có hoạt động trong ",
        rangeDays,
        " ngày qua."
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-card", style: { padding: "var(--n4-sp-4)", marginBottom: "var(--n4-sp-4)" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChartDataTable, { data: dailyData, kind: "accuracy" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-card", style: { padding: "var(--n4-sp-4)", marginBottom: "var(--n4-sp-4)" }, children: [
