...
import { u as useLearningStore, X as useNPCStore, bi as AJL_TOWN_SCENARIOS, _ as __vitePreload } from "./feature-3d-CFvJkEt3.js";
  ...
  const sendMessage = reactExports.useCallback(async () => {
    ...
    try {
      const { chatWithAI } = await __vitePreload(async () => {
        const { chatWithAI: chatWithAI2 } = await import("./feature-3d-hud-CYISTbY6.js").then((n) => n.a$);
