...
import { L as speakJP, a as useDataStore } from "./index-BEJSIlFS.js";
import { u as useDebouncedValue, E as EMPTY_SEARCH_ITEMS, N as NAV_ITEMS } from "./navigation-index-BUPaV9YS.js";
import { a as searchLocalStudyData, s as searchAppData } from "./data-index-Dcwjwz3J.js";
import { i as isOnline, a as apiFetch } from "./api-BAg1LJRR.js";
import { c as useSearchParams, a as useNavigate } from "./vendor-router-Dx6RIovR.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-dashboard n4-page-enter", style: { padding: "0 16px 16px" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        ...
        "aria-describedby": "lookup-result-count"
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "lookup-result-count", className: "n4-sr-only", "aria-live": "polite", children: [
      results.length,
      " kết quả"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: [
      ...
      navResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        !query.trim() && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.75em", color: "var(--n4-text-muted)", padding: "8px 0 4px", fontWeight: 600 }, children: "Lối tắt" }),
          ...
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { textAlign: "left" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("small", { className: "n4-palette-source", children: [
      ...
      dataResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.75em", color: "var(--n4-text-muted)", padding: "8px 0 4px", fontWeight: 600 }, children: "Nội dung học" }),
          ...
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { textAlign: "left" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontWeight: 600 }, children: item.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.8em", color: "var(--n4-text-muted)" }, children: item.desc }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("small", { className: "n4-palette-source", children: "Cục bộ · nội dung" })
              ] })
            ]
          },
