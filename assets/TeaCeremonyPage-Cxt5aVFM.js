const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./TeaRoomScene-7xSwFq2F.js","./vendor-react-BUL8WuXG.js"])))=>i.map(i=>d[i]);
...
const TeaRoom = React.lazy(() => __vitePreload(() => import("./TeaRoomScene-7xSwFq2F.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((module) => ({ default: module.TeaRoom })));
const STEPS = [
