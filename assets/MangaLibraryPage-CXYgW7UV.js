const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./MangaAlcoveScene-D8gS_JWv.js","./vendor-react-BUL8WuXG.js"])))=>i.map(i=>d[i]);
...
import { h as useLearningStore, b0 as AJL_MANGA_CHAPTERS } from "./index-BEJSIlFS.js";
...
import { B as BookOpen, h as Lock, L as LockOpen, i as Sparkles } from "./vendor-icons-D83cEu6Z.js";
...
const MangaAlcove = React.lazy(() => __vitePreload(() => import("./MangaAlcoveScene-D8gS_JWv.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((module) => ({ default: module.MangaAlcove })));
