...
function useRender(Component, props, ref, { latestValues }, isStatic, forwardMotionProps = false, isSVG) {
  const useVisualProps = (isSVG != null ? isSVG : isSVGComponent(Component)) ? useSVGProps : useHTMLProps;
...
function createMotionComponent(Component, { forwardMotionProps = false, type } = {}, preloadedFeatures, createVisualElement) {
  ...
  MotionDOMComponent.displayName = `motion.${typeof Component === "string" ? Component : `create(${(_b = (_a = Component.displayName) != null ? _a : Component.name) != null ? _b : ""})`}`;
...
const createDomVisualElement = (Component, options) => {
  var _a;
  const isSVG = (_a = options.isSVG) != null ? _a : isSVGComponent(Component);
