...
import { u as useLearningStore, X as useNPCStore, bi as AJL_TOWN_SCENARIOS, _ as __vitePreload } from "./feature-3d-jK3b4Iv-.js";
...
import { A as ArrowLeft, k as CircleCheck, m as Send } from "./vendor-icons-DHCyxOF-.js";
  ...
  const sendMessage = reactExports.useCallback(async () => {
    ...
    try {
      const { chatWithAI } = await __vitePreload(async () => {
        const { chatWithAI: chatWithAI2 } = await import("./feature-3d-hud-Dp6hMoyV.js").then((n) => n.a$);
