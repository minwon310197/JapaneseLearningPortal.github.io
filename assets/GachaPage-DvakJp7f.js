...
import { u as useLearningStore, aB as getCurrentSeason, aJ as GACHA_PHASE_TIMINGS, am as GACHA_PITY, aK as RARITY_COLORS, aL as RARITY_LABELS, aM as getCharmBonus, al as getPowerUpMeta } from "./feature-3d-CFvJkEt3.js";
import { a1 as useTakaraStore, a2 as selGems, a3 as selShards } from "./index-D1BqAvip.js";
import { G as Gacha3DScene, R as RarityStream, a as ConfettiBurst, b as SparklePing, E as EconomySceneHero } from "./feature-3d-scenery-C3eSpuWG.js";
import { G as GACHA_BOXES, d as getBoxRewardProfile, e as getBoxById, f as getFeaturedItemsForBox, s as summarizeGachaPull, S as SHOP_ITEMS, r as rollGachaBox, c as getCosmeticName } from "./cosmetic-registry-BevBw2sp.js";
import { i as installAudioPrewarm, g as getAudioBus, p as playSfx } from "./sfx-catalog-DZj5Y_7h.js";
/* empty css                 */
            ...
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-gacha-card-inner", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-gacha-card-front", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "n4-gacha-result-rarity", style: { color: RARITY_COLORS[item.rarity] }, children: RARITY_LABELS[item.rarity] }),
    ...
    mode === "coin" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      activeBox && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-gacha-spotlight", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "n4-gacha-featured", children: featuredItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `n4-gacha-featured-item rarity-${item.rarity}`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "n4-gacha-featured-rarity", style: { color: RARITY_COLORS[item.rarity] }, children: RARITY_LABELS[item.rarity] })
        ] }, item.id)) })
      ] }),
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `n4-gacha-featured-item rarity-${meta.rarity || "common"}`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                style: { color: RARITY_COLORS[meta.rarity || "common"] },
