...
import { h as useLearningStore, _ as getSrsLevel, P as getUserErrorMessage, L as speakJP } from "./index-BEJSIlFS.js";
import { u as useAIKey } from "./useAIKey-CpSw0zmN.js";
import { generateGrammarDrill } from "./ai-S4u4-t6_.js";
  ...
  const weakPatterns = reactExports.useMemo(() => {
    ...
    if (srs) {
      Object.entries(srs).forEach(([key, data]) => {
        if (key.startsWith("grammar-") && getSrsLevel(data) <= 2) {
