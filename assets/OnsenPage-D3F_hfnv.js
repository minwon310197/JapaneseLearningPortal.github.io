const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./OnsenScene-sGnpsVFl.js","./vendor-react-BUL8WuXG.js","./feature-3d-B9k2WEUa.js","./vendor-three-DqkPfKji.js"])))=>i.map(i=>d[i]);
...
const OnsenBath = React.lazy(() => __vitePreload(() => import("./OnsenScene-sGnpsVFl.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0, import.meta.url).then((module) => ({ default: module.OnsenBath })));
