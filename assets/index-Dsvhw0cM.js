const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./vendor-three-webgpu-BRkbFnNI.js","./vendor-three-DqkPfKji.js"])))=>i.map(i=>d[i]);
import { a as create, r as reactExports, j as jsxRuntimeExports } from "./vendor-react-BUL8WuXG.js";
...
import { c as createCombatText, a as createBattleBanner, g as getComboTier, G as GameplayEffects, b as getBossMood } from "./GameplayEffects-C1IXweFm.js";
import { H as getQualityConfig, x as playSFX, J as stableAnswerKey, K as equalsAnswerText, o as onStopAll, b as stopSpeech, L as speakJP } from "./index-BEJSIlFS.js";
import { u as useVocabItems, c as useKanjiItems, a as useGrammarItems, b as useSectionList } from "./useDataHelper-DtTUT9Wk.js";
...
function WebGPUCanvas({ onRendererReady, className = "", style }) {
  ...
  const disabled = inWorld || getQualityConfig().tier === "low";
  ...
  const init = reactExports.useCallback(async () => {
    ...
    try {
      const THREE = await __vitePreload(() => import("./vendor-three-webgpu-BRkbFnNI.js").then((n) => n.t), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
      ...
      try {
        const { WebGLRenderer } = await __vitePreload(async () => {
          const { WebGLRenderer: WebGLRenderer2 } = await import("./vendor-three-DqkPfKji.js").then((n) => n.g0);
    ...
    const { Scene, PerspectiveCamera } = await __vitePreload(async () => {
      const { Scene: Scene2, PerspectiveCamera: PerspectiveCamera2 } = await import("./vendor-three-DqkPfKji.js").then((n) => n.g0);
...
async function createSlashParticles(count = 1e4) {
  ...
  const { storage, instanceIndex, Fn, color, pass } = await __vitePreload(async () => {
    const { storage: storage2, instanceIndex: instanceIndex2, Fn: Fn2, color: color2, pass: pass2 } = await import("./vendor-three-webgpu-BRkbFnNI.js").then((n) => n.a);
