...
import { d as useLearningStore, x as useNPCStore, bP as AJL_TOWN_SCENARIOS, _ as __vitePreload } from "./feature-3d-ClP3ARU5.js";
import { r as reactExports, j as jsxRuntimeExports } from "./vendor-react-BYxMSDiB.js";
import { a as awardAjlRewards } from "./ajl-rewards-Cd-OA6vJ.js";
  ...
  const sendMessage = reactExports.useCallback(async () => {
    ...
    try {
      const { chatWithAI } = await __vitePreload(async () => {
        const { chatWithAI: chatWithAI2 } = await import("./feature-3d-ClP3ARU5.js").then((n) => n.dc);
