...
import { h as useLearningStore, l as formatEconomySourceLabel } from "./index-BEJSIlFS.js";
import { G as GACHA_BOXES, c as getBoxRewardProfile } from "./cosmetic-registry-CEb8QiBv.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-stats-page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "n4-stats-chart-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        {
          viewBox: "0 0 350 140",
          className: "n4-stats-bar-chart",
          role: "img",
          "aria-label": "Biểu đồ cột thu nhập xu trong 7 ngày gần đây",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Biểu đồ thu nhập 7 ngày" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("desc", { children: "Trục hoành biểu diễn các ngày, trục tung biểu diễn số lượng xu kiếm được." }),
            dailyKeys.map((key, i) => {
